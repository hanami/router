      ...
      context "##{verb}" do
        ...
        context "path recognition" do
          context "root trailing slash" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "14"}), "Trailing root!") }
          ...
          context "trailing slash" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "9"}), "Trailing!") }
          ...
          context "fixed string" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "6"}), "Fixed!") }
          ...
          context "moving parts string" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "7"}), "Moving!") }
          ...
          context "globbing string" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "9"}), "Globbing!") }
          ...
          context "format string" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "7"}), "Format!") }
          ...
          context "block" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "6"}), "Block!") }
        ...
        describe "constraints" do
          let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "24"}), "Moving with constraints!") }
        ...
        context "named routes" do
          context "symbol" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "12"}), "Named route!") }
          ...
          context "compiled variables" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "13"}), "Named %route!") }
          ...
          context "custom url parts" do
            let(:response) { Rack::MockResponse.new(200, rack_headers({"Content-Length" => "30"}), "Named route with custom parts!") }
