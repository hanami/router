...
module Hanami
  class Router
    ...
    class Segment
      ...
      #   @segment = Mustermann.new(segment, type: :rails, version: "5.0", capture: constraints)
      # end
      ...
      #   @segment.expand(variables, :append)
      # end
      ...
      def escape_variable(var, constraints) # rubocop:disable Metrics/MethodLength
